...
-- Usuarios: ven eventos activos y pueden crear los suyos
...
-- Usuarios: pueden registrar asistencias en sus eventos
...
-- Para crear usuarios, usa el Dashboard de Supabase:
-- Authentication → Users → Add User
-- 
-- O desde SQL (solo para desarrollo):
-- 
